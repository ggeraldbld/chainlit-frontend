...
import { a as b, g, u as v } from './ChainlitFrontend-D6NIyKXq.js';
...
var f = E(_),
  ...
  y = v,
  P = b;
const C = 'https://play.vidyard.com/embed/v4.js',
  N = 'VidyardV4',
  x = 'onVidyardAPI';
class d extends c.Component {
  ...
  render() {
    ...
    return /* @__PURE__ */ c.default.createElement(
      'div',
      { style: r },
      /* @__PURE__ */ c.default.createElement('div', { ref: this.ref })
    );
  }
}
