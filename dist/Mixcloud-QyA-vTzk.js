...
import { u as f, a as m, g as y } from './ChainlitFrontend-BQjC3Dnz.js';
...
var h = S(d),
  ...
  u = f,
  _ = m;
const L = 'https://widget.mixcloud.com/media/js/widgetApi.js',
  T = 'Mixcloud';
class l extends p.Component {
  ...
  render() {
    const { url: e, config: r } = this.props,
      s = e.match(_.MATCH_URL_MIXCLOUD)[1],
      o = {
        width: '100%',
        height: '100%'
      },
