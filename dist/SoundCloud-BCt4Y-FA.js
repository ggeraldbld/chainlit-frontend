...
import { g as P, a as b, u as g } from './ChainlitFrontend-D6NIyKXq.js';
...
var S = Object.create,
  ...
  M = (t) => c(l({}, '__esModule', { value: !0 }), t),
  a = (t, e, r) => (E(t, typeof e != 'symbol' ? e + '' : e, r), r),
  h = {};
L(h, {
  default: () => u
});
...
class u extends p.Component {
  constructor() {
    super(...arguments),
      a(this, 'callPlayer', d.callPlayer),
  ...
  load(e, r) {
    (0, d.getSDK)(N, A).then((s) => {
      ...
      r ||
        ...
        this.player.bind(y, () => this.props.onEnded()),
  ...
  render() {
    ...
    return /* @__PURE__ */ p.default.createElement('iframe', {
      ref: this.ref,
