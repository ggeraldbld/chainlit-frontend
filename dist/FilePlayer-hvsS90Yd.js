...
import { a as O, u as _, g as b } from './ChainlitFrontend-BQjC3Dnz.js';
  ...
  constructor() {
    super(...arguments),
      ...
      r(this, 'renderSourceElement', (e, t) =>
        typeof e == 'string'
          ? /* @__PURE__ */ d.default.createElement('source', {
              key: t,
              src: e
            })
          : /* @__PURE__ */ d.default.createElement('source', { key: t, ...e })
      ),
      r(this, 'renderTrack', (e, t) =>
        /* @__PURE__ */ d.default.createElement('track', { key: t, ...e })
      ),
      r(this, 'ref', (e) => {
